...
INSERT INTO public.post(postdate, title, author_id,content) VALUES (CURRENT_TIMESTAMP(), 'Aliquam dictum dui vel', '1', 'enean facilisis justo accumsan, et lorem elit ?');
INSERT INTO public.post(postdate, title, author_id,content) VALUES (CURRENT_TIMESTAMP(), ' Sed pharetra', '2','Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nunc eget nulla sit amet ligula semper auctor. ');
INSERT INTO public.post(postdate, title, author_id,content) VALUES (CURRENT_TIMESTAMP(), 'Duis a imperdiet libero', '2',  'Donec pellentesque, elit sit amet semper ornare, elit tortor molestie dui, commodo tincidunt turpis est id ligula. Fusce vitae ligula non lacus auctor finibus in id augue. Mauris lobortis libero sit amet nibh egestas, condimentum mattis orci iaculis. ');
INSERT INTO public.post(postdate, title, author_id,content) VALUES (CURRENT_TIMESTAMP(), 'Lorem ipsum', '3',
